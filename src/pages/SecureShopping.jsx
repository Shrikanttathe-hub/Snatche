...
import '../assetss/CSS3/secureShopping.css';
...
const SecureShopping = () => {
  return (
    <>
      ...
      <section className="secureShopping">
        <div className="container">
          <div className="secureShopping_main">
            ...
            <div className="secureShoppingContent">
              <h2>Secure Shopping Policy</h2>
              <p>
